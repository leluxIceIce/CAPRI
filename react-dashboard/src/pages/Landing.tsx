      ...
      <main className="max-w-[1280px] w-full mx-auto px-4 sm:px-6">
        <section className="py-20 sm:py-28 flex flex-col items-center text-center gap-6">
          ...
          <h1 className="text-4xl sm:text-6xl font-black tracking-tight text-white max-w-3xl">
            EEF — Ecological Encoding Framework
          </h1>
          <p className="text-sm sm:text-base text-white/60 max-w-xl leading-relaxed">
            A real-time 3D geospatial telemetry dashboard for exploring seven spectral
            ocean-color variables at once. Stream synthetic sensor data or play back your
            own CSV captures across a live multi-layer Three.js terrain, then read the
            scientific diagnostics panel for regime and anomaly signals — all running
